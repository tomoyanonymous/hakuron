\documentclass[luatex,japanese,unicode,titlepage,pdfusetitle,a4paper,openany]{ltjsbook}
\usepackage{luatexja}
...
\usepackage[language=japanese,backend=biber,nameorder=true,date=year,style=authoryear]{biblatex-japanese}
