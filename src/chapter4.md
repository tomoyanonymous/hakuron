...
トロップの指す、1960年代の音楽専攻の学生の大量雇用という事実の詳細に関しては不明であるし、音楽の技能とプログラミングの技能の相関性もひどく主観的なものではある。しかしそれでも筆者は、初期のコンピュータープログラミングの作業にAlgorhythmic Listening的な実践が入ってくることは必然だったと主張したい。BINACとほぼ同時期にコンピューターで音楽を奏でる最初期の実践を行なった計算機としては、UNIVAC I(1951)がBINAC同様AMラジオを用いていたり、オーストラリアのCSIRAC（当初の名前はCSIR Mark 1）（1950）がデバッグや処理終了時の通知音を鳴らすためのスピーカーが用いたり代表例として挙げられ[@Dournbush2017]、これらはどれも、

宮崎が着目していなかった点になるが、はどれも、そもそもはじめから、ラジオに流れる電磁波を拾うまでもなく、音響遅延線メモリーという音楽文化とテクノロジーの交差点上に生まれた仕組みを採用していたからだ[^williams]。
