...
Csoundでは1990年に外部モジュールなしでのリアルタイム動作が行えるようになった。これは結局、4Xのわずか5、6年後ということになる。
...
ダイナミックリンクが可能になったことで、UGenをコンパイル済みのバイナリとして（プラグインのように）拡張できるようになった。このあたりから、ユーザーは下層の言語を完全に知らないままに使えるようになってきたと言える
