...
エマーソンはこうしたアプローチを、タイプライターというインターフェースによって画一化される読み書きのインターフェースに抗うように発生した具体詩（コンクリート・ポエトリー）という、文字の空間的レイアウトや視覚的形状を作品の要素とする運動と並置して、アーティスト、デザイナーのためのグラフィックプログラミング環境Processingを用いたメアリー・フラナガンのようなアーティストの作品と接続することを試みた[@Emmerson2014]。
